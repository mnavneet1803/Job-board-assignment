...
exports.findListIndexes =  function findListIndexes(objectArray) {
	var indexArr = [];
...
exports.markListItems =  function markListItems(objectArr, indexArr) {
...
exports.findOrderedListItems =  function findOrderedListItems(objectArr) {
	var inList = false;
	var listNum = 1;
